...
.txt15_140,.txt15_120{font-size:1.5rem;line-height:140%}
.ie .txt15_140{font-size:15px}
.txt15_120{line-height:120%}
.txt14_140,.txt14_120{font-size:1.4rem;line-height:140%}
.txt14_120{line-height:120%}
.ie .txt14_140,.ie .txt14_120{font-size:14px}
.txt13_140,.txt13_120{font-size:1.3rem;line-height:140%}
.txt13_120{line-height:120%}
.ie .txt13_140,.ie .txt13_120{font-size:13px}
.txt12{line-height:120%;font-size:1.2rem}
.ie .txt11{font-size:12px}
.txt11{line-height:120%;font-size:1.1rem}
.ie .txt11{font-size:11px}
.txt10{line-height:120%;font-size:1rem}
.ie .txt10{font-size:10px}
.txt15_120,.txt14_140,.txt14_120,.txt13_140,.txt13_120,.txt12,.txt11,.txt10{font-family:arial,sans-serif}
.container_18{margin:0 13px;width:974px}
.grid_1,.grid_2,.grid_3,.grid_4,.grid_5,.grid_6,.grid_7,.grid_8,.grid_9,.grid_10,.grid_11,.grid_12,.grid_13,.grid_14,.grid_15,.grid_16,.grid_17,.grid_18{box-sizing:border-box;-moz-box-sizing:border-box;-webkit-box-sizing:border-box;display:inline;float:left;position:relative;margin-left:8px;margin-right:8px}
...
.ombre_section,.deroule_edito,.deroule_fleuve,.une_edito{-webkit-box-shadow:0 6px 6px -6px rgba(202,205,209,1);-moz-box-shadow:0 6px 6px -6px rgba(202,205,209,1);box-shadow:0 6px 6px -6px rgba(202,205,209,1);padding-top:0;margin-bottom:16px;margin-top:16px;overflow:hidden}
a{color:#036;text-decoration:none;cursor:pointer}
a:hover,a:focus,a:active,.lien_focus,.flashy{color:#129af0}
.bg_fonce a{color:#129af0;opacity:.85}
.bg_fonce a:hover,.bg_fonce a:focus{opacity:1.0}
...
.btn:active,.btn_fonce:active,.btn_abo:active,.btn_petit:active{background-image:none;-webkit-box-shadow:inset 0 2px 4px rgba(0,0,0,.15),0 1px 2px rgba(0,0,0,.05);-moz-box-shadow:inset 0 2px 4px rgba(0,0,0,.15),0 1px 2px rgba(0,0,0,.05);box-shadow:inset 0 2px 4px rgba(0,0,0,.15),0 1px 2px rgba(0,0,0,.05);outline:0}
...
.fb20x20,.tw20x20,.google20x20,.mobile20x20,.rss20x20{background:url(/medias/web/img/sprites/pictos20x20.png) no-repeat;display:inline-block;text-indent:-9999px;height:20px;width:20px;vertical-align:middle;margin-left:4px}
...
.fb13x13,.tw13x13,.google13x13,.linkedin13x13,.fb13x13_gris,.tw13x13_gris,.fb13x13_blanc,.tw13x13_blanc,.google13x13_blanc,.linkedin13x13_blanc{margin:0 2px;vertical-align:middle}
...
.nb_reactions .pic,.nb_commentaires .pic{vertical-align:text-bottom;margin:0 3px 0 0;width:12px;height:11px;background-position:-13px 0}
...
.bt_ouvrir,.bt_fermer,.bt_ouvrir:hover,.bt_fermer:hover{width:16px;height:14px}
...
.liste_chevron a:before,.liste_chevron .obf:before,.chevron:before{color:#a2a9ae;content:'\203A';font-family:arial;display:inline-block;font-size:13px;left:0;position:relative;width:7px;font-weight:400}
...
.titres_abonnes .entete,.entete_exclu_abonnes{display:block;height:19px;background:#ffd500 url(/medias/web/img/elements_lm/ea_contenu_exclusif.png) no-repeat 8px 4px;font-size:13px;text-indent:-9999px}
...
.liste_img_lien img,.liste_img_lien .img_ico{float:left;margin-right:8px}
...
.global a.entete_deroule:hover,.global .entete_deroule.obf:hover{background:#f5f8f9;color:#16212c;cursor:pointer}
.global .bloc_droit,.global .bloc_bandeau{border:1px solid #eef1f5;overflow:hidden;background:#fafbfc}
.global .bloc_droit strong{display:block;height:31px;overflow:hidden}
.global .bloc_droit+.bloc_droit{margin:16px 0 0}
.global .supplement_partenaire,.col_droite .supplement_partenaire{margin-top:16px;overflow:hidden;border:1px solid #e9edf0;color:#5d666d}
.global .supplement_partenaire .entete,.col_droite .supplement_partenaire.entete{height:25px;padding:0 16px;border-bottom:1px solid #e9edf0;font-size:13px;line-height:24px;font-weight:700}
.global .supplement_partenaire .entete .marqueur_pub,.col_droite .supplement_partenaire.entete .marqueur_pub{float:right;display:inline-block;width:43px;height:5px;margin-top:10px;background:url(/medias/web/img/textes/marqueur_pub_gris43x5.png);text-indent:-9999px;font-size:9px;text-transform:uppercase}
.global .supplement_partenaire .contenu,.col_droite .supplement_partenaire .contenu{overflow:hidden;padding:16px 15px}
.global .supplement_partenaire .contenu{height:66px}
.global .supplement_partenaire .contenu .img,.col_droite .supplement_partenaire .contenu .img{float:left;width:63px}
.global .supplement_partenaire .contenu .img img,.col_droite .supplement_partenaire .contenu .img img{border:1px solid #eef1f5}
.global .supplement_partenaire .contenu .annonce,.col_droite .supplement_partenaire .contenu .annonce{float:left;margin-left:10px;width:209px}
.global .supplement_partenaire,.col_droite .supplement_partenaire .annonce .accroche{display:block;margin-bottom:5px;font-weight:700}
.global .bloc_droit .bandeau,.global .bloc_bandeau .bandeau{padding:0 16px;margin:0;font-size:17px;line-height:26px;color:#fff;text-transform:uppercase}
...
.lien_chaine,.deroule_edito .liens_bas{width:100%;clear:both;padding:6px 0 0;margin:-3px 0 0;border-top:1px solid #eef1f5;text-align:center}
...
.global.audience .container img:hover,#carousel_footer_serviciel img:hover{opacity:.7;-ms-filter:"alpha(Opacity=70)"}
...
.fleuve .lire,.article .lire{padding:8px 16px 6px;clear:both;background:#f8f9fb;border-left:1px solid #e4e6e9;font-weight:700;margin:20px 0}
.fleuve .twit,.article .twit{padding:8px 16px 6px;clear:both;overflow:hidden;background:#f8f9fb;border-left:3px solid #41c8f5;margin:20px 0;font-size:12px;line-height:18px}
.fleuve .twit .img,.article .twit .img{float:left;width:58px}
.fleuve .twit img,.article .twit img{margin-right:10px;border-radius:4px}
.fleuve .twit .texte_twit,.article .twit .texte_twit{display:block;float:left;width:85%;margin:0}
...
.ico_portfolio,.ico_infographie,.ico_video,.ico_live{display:inline-block;background-image:url(/medias/web/img/sprites/icos_medias.png);text-indent:-9999px;position:absolute}
...
.ico_portfolio_mini,.ico_infographie_mini,.ico_video_mini,.ico_live_mini{display:inline-block;background-image:url(/medias/web/img/sprites/icos_medias.png)}
...
.logo_lm_abo95x16,.logo_lm95x16{display:inline-block;width:95px;height:16px;background:url(/medias/web/img/elements_lm/logo_lm95x16.png);text-indent:-9999px;font-size:13px;vertical-align:baseline}
...
#footer a:hover,#footer .obf:hover{text-decoration:underline}
...
#footer .footer_listes a,#footer .footer_listes span,#footer .footer_bas a,#footer .footer_bas span,#footer .footer_listes li{color:#a2a9ae}
...
#footer .footer_bas p,#footer .footer_bas div{float:left}
...
.col_droite .position_pub.filled.noborder{background:0;padding:0}
...
.conteneur_carrousel .navigation .precedent,.conteneur_carrousel .navigation .suivant{display:inline-block;vertical-align:middle}
...
.conteneur_carrousel .repere:hover,.conteneur_carrousel .repere.actif{background-position:-11px -24px;cursor:pointer}
.conteneur_carrousel img{display:block;border:0}
.portfolio_appel_revolutionnaire.conteneur_carrousel .navigation .reperes,.portfolio_appel_revolutionnaire .portfolio_data_container h2{display:none}
...
#header,#barre_titre,#nav{position:relative}
#header{z-index:3}
...
#surheader .gauche .actif,#surheader .gauche a:hover,#surheader .gauche .obf:hover{background:#000b15;color:#fff}
*+html #surheader>a,#surheader .bt_abo{display:block;float:right;padding:0 16px;color:#000}
...
#header .logo_lm_abo95x16,#header .logo_lm95x16{float:left;margin:7px 16px 0 0}
...
#header_utilisateur .sociaux span,#header_utilisateur .sociaux a{vertical-align:middle;margin-right:7px}
.sociaux .obf,.sociaux .obf strong,.sociaux .obf span,.sociaux .obf:hover strong,.sociaux .obf:hover span,.sociaux .obf:focus strong,.sociaux .obf:focus span{color:#000;text-decoration:none}
.sociaux .obf{color:#036}
.sociaux .obf:hover,.sociaux .obf .obf:focus{color:#900}
...
.loginbox .login_form .btn_abo,.loginbox .abonne_journal .btn{position:absolute;bottom:15px;left:16px}
...
.ombrelle.style .widget:hover,.ombrelle.politique .widget:hover{opacity:.7;-ms-filter:"alpha(Opacity=70)"}
...
#nav li:hover a,#nav a:hover,#nav li:hover .obf,#nav .obf:hover{color:#fff}
...
#nav_ariane .ariane a,#nav_ariane .ariane .obf{padding:12px 5px 0 20px;color:#fff}
#nav_ariane .ariane>a{color:#6a718b}
#nav_ariane .ariane a:hover,#nav_ariane .ariane .obf:hover{color:#fff}
...
#ariane_az #sn .navlist li:hover{border-color:#eef1f5}
#ariane_az #sn .navlist li:hover+li{border-color:#eef1f5}
#ariane_az #sn .navlist li a{height:28px;line-height:28px;padding:0 8px;font-size:12px;border:0}
#ariane_az #sn .navlist li a:hover,#ariane_az #sn .navlist li a:focus,#ariane_az #sn .navlist li a:hover span,#ariane_az #sn .navlist li a:focus span,#ariane_az #sn .navlist .cur a span{background:0;color:#6faa12}
...
.debrief a,.debrief .obf{color:#f8f9fb}
...
.liste_reactions .intitule span,.liste_reactions .btn span{color:#747b83}
...
.reaction_identifier .non_abo,.conteneur_barre_outils .non_abo.classer{position:relative;float:left;width:233px;height:230px;padding:10px 10px 10px 14px;background:url(/medias/web/img/textes/daccord_pas_daccord.png) no-repeat 16px 40px;border-right:1px solid #fff}
...
.reaction_redaction .signature .modifier,.reaction_redaction .signature .annuler{cursor:pointer}
...
.bloc_base.meme_sujet,.bloc_base.appel_temoignage{margin-top:16px}
...
.services .bloc_part.grid_6,.services .bloc_part.grid_12{margin-left:16px;margin-right:0}
...
.bloc_part .btn_fonce,.bloc_part .btn{position:absolute;bottom:15px}
...
.services .bloc_part.gymglish.grid_6{background:0}
...
.bloc_part.gymglish .exercice .img,.bloc_part.gymglish .cours .img{width:110px;float:right}
...
.bloc_part.la_centrale .contenu,.bloc_part.immostreet .contenu{padding:12px 15px 10px}
...
.bloc_part .contenu.carrousel_petit,.bloc_part .contenu.carrousel_grand{position:relative;width:644px;height:182px;overflow:hidden;padding:0}
...
.bloc_part .contenu.carrousel .prev,.bloc_part .contenu.carrousel .next{display:block;width:13px;height:21px;text-shadow:0 1px 1px rgba(255,255,255,.75);background-color:#fafafa;background-image:-webkit-gradient(linear,0 0,0 100%,from(#fefefe),color-stop(25%,#fefefe),to(#e4e6e9));background-image:-webkit-linear-gradient(#fefefe,#fefefe 25%,#e4e6e9);background-image:-moz-linear-gradient(top,#fefefe,#fefefe 25%,#e4e6e9);background-image:-ms-linear-gradient(#fefefe,#fefefe 25%,#e4e6e9);background-image:-o-linear-gradient(#fefefe,#fefefe 25%,#e4e6e9);background-image:linear-gradient(#fefefe,#fefefe 25%,#e4e6e9);background-repeat:no-repeat;filter:progid:DXImageTransform.Microsoft.gradient(startColorstr='#fefefe', endColorstr='#e4e6e9', GradientType=0);font-size:21px;line-height:15px;color:#2e3942}
.bloc_part .contenu.carrousel .prev:hover,.bloc_part .contenu.carrousel .next:hover{color:#2e3942;text-decoration:none;background-color:#e4e6e9;background-position:0 -15px;-webkit-transition:background-position .1s linear;-moz-transition:background-position .1s linear;-ms-transition:background-position .1s linear;-o-transition:background-position .1s linear;transition:background-position .1s linear;cursor:pointer}
...
.col_droite .twtr-widget .twtr-join-conv:hover,.col_droite .twtr-widget .twtr-join-conv:focus,.col_droite.twtr-widget .twtr-join-conv:active{color:#129AF0!important}
...
.col_droite .bloc_base .footer span,.col_droite .bloc_base .footer img{vertical-align:middle}
.bloc_part .footer img{margin:0 0 0 5px}
...
.col_droite .liste_img_lien figure,.col_droite .liste_img_lien figcaption{height:auto}
...
.col_droite .boite_recherche{background:0;padding:8px 16px 10px}
...
.conteneur_lives .lives .chrome a,.conteneur_lives .live .bandeau .voir{display:inline-block;text-decoration:none;float:right;margin:4px 0 0 5px;height:15px;width:14px}
.conteneur_lives .live .bandeau .voir,.conteneur_lives .lives .chrome .live_replier,.conteneur_lives .lives .chrome .popup,.conteneur_lives .lives .chrome .live_deplier,.conteneur_lives .lives .chrome .live_fermer{background-image:url(/medias/web/img/sprites/icos_live.png)}
...
.conteneur_lives .lives.grand .chrome .live_replier,.conteneur_lives .lives.grand .chrome .popup,.conteneur_lives .lives.grand .chrome .live_deplier,.conteneur_lives .lives.grand .chrome .live_fermer{opacity:.6}
.conteneur_lives .lives.grand .chrome .live_replier:hover,.conteneur_lives .lives.grand .chrome .popup:hover,.conteneur_lives .lives.grand .chrome .live_deplier:hover,.conteneur_lives .lives.grand .chrome .live_fermer:hover{opacity:1}
...
.conteneur_lives .live.petit .toast,.conteneur_lives .live.petit .cil{display:none}
.conteneur_lives .live.moyen .cil,.conteneur_lives .live.moyen .bandeau{display:none}
...
.global.fonce a,.global.fonce span,.global.fonce .obf{color:#eef1f5}
.global.fonce a:hover,.global.fonce span:hover,.global.fonce .obf:hover,.global.fonce a:hover .tt17{color:#a2a9ae}
...
.international #ariane_az a:hover,.international #ariane_az .obf:hover,.ombrelle.international .tt_rubrique_ombrelle,.ombrelle.international h2 .obf,.ombrelle.international h2 .obf:hover,.international .tt_rubrique,.international .jour_parution,.international .couleur_rubrique{color:#0386c3}
...
.politique #ariane_az a:hover,.politique #ariane_az .obf:hover,.ombrelle.politique .tt_rubrique_ombrelle,.ombrelle.politique h2 .obf,.ombrelle.politique h2 .obf:hover,.politique .tt_rubrique,.politique .couleur_rubrique{color:#1f0d67}
...
.societe #ariane_az a:hover,.societe #ariane_az .obf:hover,.ombrelle.societe .tt_rubrique_ombrelle,.ombrelle.societe h2 .obf,.ombrelle.societe h2 .obf:hover,.societe .tt_rubrique,.societe .jour_parution,.societe .couleur_rubrique{color:#d50303}
...
#nav_ariane.economie .ariane a:hover,#nav_ariane.economie .ariane .obf:hover{color:#fff}
.economie #ariane_az a:hover,.economie #ariane_az .obf:hover,.ombrelle.economie .tt_rubrique_ombrelle,.ombrelle.economie h2 .obf,.ombrelle.economie h2 .obf:hover,.economie .tt_rubrique,.economie .jour_parution,.economie .couleur_rubrique{color:#fe2f2f}
...
.culture #ariane_az a:hover,.culture #ariane_az .obf:hover,.ombrelle.culture .tt_rubrique_ombrelle,.ombrelle.culture h2 .obf,.ombrelle.culture h2 .obf:hover,.culture .tt_rubrique,.culture .jour_parution,.culture .couleur_rubrique{color:#f20559}
...
#nav_ariane .ariane{background:url(/medias/web/img/sprites/sous_nav.png) no-repeat right -175px}
#ariane_az a:hover,#ariane_az .obf:hover,.ombrelle .tt_rubrique_ombrelle,.ombrelle h2 .obf,.ombrelle h2 .obf:hover,.tt_rubrique,.jour_parution,.couleur_rubrique{color:#2e3942}
...
.education #ariane_az a:hover,.education #ariane_az .obf:hover,.ombrelle.education .tt_rubrique_ombrelle,.ombrelle.education h2 .obf,.ombrelle.education h2 .obf:hover,.education .tt_rubrique,.education .jour_parution,.education .couleur_rubrique{color:#ff6e17}
...
.planete #ariane_az a:hover,.planete #ariane_az .obf:hover,.ombrelle.planete .tt_rubrique_ombrelle,.ombrelle.planete h2 .obf,.ombrelle.planete h2 .obf:hover,.planete .tt_rubrique,.planete .jour_parution,.planete .couleur_rubrique{color:#30932e}
...
.sante #ariane_az a:hover,.sante #ariane_az .obf:hover,.ombrelle.sante .tt_rubrique_ombrelle,.ombrelle.sante h2 .obf,.ombrelle.sante h2 .obf:hover,.sante .tt_rubrique,.sante .jour_parution,.sante .couleur_rubrique{color:#189494}
...
.sport #ariane_az a:hover,.sport #ariane_az .obf:hover,.ombrelle.sport .tt_rubrique_ombrelle,.ombrelle.sport h2 .obf,.ombrelle.sport h2 .obf:hover,.sport .tt_rubrique,.sport .jour_parution,.sport .couleur_rubrique{color:#6faa12}
...
.sciences #ariane_az a:hover,.sciences #ariane_az .obf:hover,.ombrelle.sciences .tt_rubrique_ombrelle,.ombrelle.sciences h2 .obf,.ombrelle.sciences h2 .obf:hover,.sciences .tt_rubrique,.sciences .jour_parution,.sicences .couleur_rubrique{color:#0cb4ae}
...
.techno #ariane_az a:hover,.techno #ariane_az .obf:hover,.ombrelle.techno .tt_rubrique_ombrelle,.ombrelle.techno h2 .obf,.ombrelle.techno h2 .obf:hover,.techno .tt_rubrique,.techno .jour_parution,.techno .couleur_rubrique{color:#006169}
.global.style{border-top:3px solid #020818}
.global.style .entete_deroule{color:#020818}
.global.style .bandeau{background:#020818}
#nav.accueil .style,#nav .style:hover a{border-top-color:#020818}
...
.ombrelle.style .tt_rubrique_ombrelle,.ombrelle.style h2 .obf,.ombrelle.style h2 .obf:hover,.style .tt_rubrique,.style .jour_parution,.style .couleur_rubrique{color:#020818}
.style #ariane_az a:hover,.style #ariane_az .obf:hover{color:#3a4971}
...
.vous #ariane_az a:hover,.vous #ariane_az .obf:hover,.ombrelle.vous .tt_rubrique_ombrelle,.ombrelle.vous h2 .obf,.ombrelle.vous h2 .obf:hover,.vous .tt_rubrique,.vous .jour_parution,.vous .couleur_rubrique{color:#820250}
...
.vous #ariane_az a:hover,.vous #ariane_az .obf:hover,.ombrelle.vous .tt_rubrique_ombrelle,.ombrelle.vous h2 .obf,.ombrelle.vous h2 .obf:hover,.vous .tt_rubrique,.vous .jour_parution{color:#820250}
.abonnes #ariane_az a:hover,.abonnes #ariane_az .obf:hover,.ombrelle.abonnes .tt_rubrique_ombrelle,.ombrelle.abonnes h2 .obf,.ombrelle.abonnes h2 .obf:hover,.abonnes .tt_rubrique,.abonnes .jour_parution,.abonnes .couleur_rubrique{color:#ffd500}
#ariane_az .ariane a:hover,#ariane_az .ariane .obf:hover,#nav_ariane .ariane.actif a,#nav_ariane .ariane.actif span{color:#fff}
...
.col_droite .inscription_alerte_election .saisie{width:272px}
#alerte_election_coldroite .conteneur_autocompletion{width:272px}
...
.une_edito .boite_recherche>p,.boite_inline .boite_recherche>p{display:inline}
.une_edito .grid_12 .boite_recherche>p{display:block;margin:5px 0 0}
.une_edito .btn.adroite,.boite_inline .btn.adroite{margin-top:5px}
...
.reception_alertes_resultats table th,.reception_alertes_resultats table td{padding:8px;border:solid 1px #b9c0c5}
...
body.access-pre .block-ad,body.access-ess .block-ad{display:none!important}
.clear{clear:both}
...
#header-liberation .header-base .home,#header-liberation .header-base .sites-info-search,#header-liberation .header-base .links,#header-liberation .header-base .digitalpaper{display:block;float:left}
...
.block.rounded,.block .block-content.rounded{border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px}
...
#core-liberation .block-basic-curled .block-top,#core-liberation .block-basic-curled .block-content{position:relative;z-index:1000;background:#fff}
...
#core-liberation .pagination .disabled,#core-liberation .pagination .current{background:#7d7d7d;color:#fff}
...
#core-liberation,#header-liberation,#footer-liberation{display:block;clear:both;margin:0 0 14px}
...
ul.list li:first-child,ul.list li.new-line{clear:both;margin-left:0}
...
.site-liberation #header-liberation h2,.site-liberation #header-liberation h1{font-family:Verdana,Arial,Helvetica,sans-serif}
...
#header-liberation .header-base .home,#header-liberation .header-base .sites-info-search,#header-liberation .header-base .links,#header-liberation .header-base .digitalpaper{height:120px}
...
#header-liberation .header-base .digitalpaper a.dl,#header-liberation .header-base .digitalpaper a.abo{display:block;position:absolute;top:15px;right:0;width:79px;height:34px;padding-left:10px;padding-top:7px;font-size:11px;font-family:Arial,Verdana,sans-serif}
...
#header-liberation .header-base .nav .nav1 .on a span,#header-liberation .header-base .nav-no-js>li:hover .nav1 a span,#header-liberation .header-base .nav .nav1 a:hover span{width:9px;height:9px}
...
:first-child+html #header-liberation .header-annex ul li{display:block;float:left}
...
#footer-liberation .news{width:168px;padding:0 14px}
#footer-liberation .services{width:168px;padding:0 14px}
...
form input[type=text],form input[type=password]{border:1px solid;padding:3px;height:14px}
form select{padding:1px;height:20px}
#core-liberation form textarea{resize:vertical}
#core-liberation form input[type=text]:focus,#core-liberation form input[type=password]:focus,#core-liberation form input[type=file]:focus,#core-liberation form textarea:focus,#core-liberation form select,#core-liberation form checkbox{outline:1px solid}
...
#core-liberation .form-monlibe input[type=text],#core-liberation .form-monlibe input[type=password],#core-liberation .form-monlibe textarea{border:1px solid;font-size:12px;margin-bottom:20px;padding:3px}
...
#core-liberation .w26unit .form-monlibe input[type=text],#core-liberation .w26unit .form-monlibe input[type=password],#core-liberation .w26unit .form-monlibe textarea{width:652px}
#core-liberation .w17unit .form-monlibe input[type=text],#core-liberation .w17unit .form-monlibe input[type=password],#core-liberation .w17unit .form-monlibe textarea{width:412px}
...
#core-liberation .form-https p input[type=text],#core-liberation .form-https p input[type=password]{display:block;width:372px;border-radius:2px;-moz-border-radius:2px;-webkit-border-radius:2px;-o-border-radius:2px;margin-bottom:14px;padding:7px}
#core-liberation .form-https .btn-rounded-degraded,#core-liberation .form-https .btn-laune{margin-top:7px;float:right}
...
#core-liberation ul.list-items li h5,#core-liberation ul.list-items li h4,#core-liberation ul.list-items li p{margin-left:98px}
...
#core-liberation ul.list-items li img.square,#core-liberation ul.list-items li img.signature{width:84px;height:84px}
#core-liberation ul.list-items li.full h5,#core-liberation ul.list-items li.full h4,#core-liberation ul.list-items li.full p{margin-left:0}
...
.col-contextual>div:first-child,.col-contextual>.first{margin-top:0;margin-bottom:0}
.col-contextual>.div:last-child,.col-contextual>.block:last-child{margin-bottom:28px}
...
.col-part .block .follow-libe .fb,.col-part .block .follow-libe .twitter,.col-part .block .follow-libe .nv-rss{padding-top:7px}
.col-part .block .follow-libe .fb p,.col-part .block .follow-libe .twitter p,.col-part .block .follow-libe .nv-rss p{font-size:10px}
...
#core-liberation .flat-comments .comment,#core-liberation .block-comments .comment_level_0{margin-top:20px;border-top:1px solid}
#core-liberation .flat-comments .comment:first-of-type,#core-liberation .block-comments .comment_level_0:first-of-type{margin-top:0}
#core-liberation .flat-comments .comment>.comment_outer,#core-liberation .block-comments .comment_level_0>.comment_outer{margin-left:-1px;border:1px solid;border-top:0}
...
#core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .who,#core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .details,#core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .note{padding-right:35px}
...
#core-liberation .block-comments .block-content .meta .who,#core-liberation .block-comments .block-content .meta .details,#core-liberation .block-comments .block-content .meta .note,#core-liberation .block-comments .block-content .meta .when{display:block}
...
#core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .who,#core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .details,#core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .note{padding-right:41px}
...
.comment_god_actions ul,.comment_god_actions li,.comment_god_actions form{display:inline-block}
...
#core-liberation .block-partnership .block-content ul li a,#core-liberation .block-partnership .block-content a.arrow{background:url(http://s0.libe.com/libe/img/common/ico-lnk-arrow-red.gif?feba6ff926a7) no-repeat 0 4px;padding-left:15px}
#core-liberation .block-pager-labo{padding:14px}
#core-liberation .block-pager-labo .block-top,#core-liberation .block-pager-labo .block-content{margin-bottom:14px}
...
#core-liberation .col .block-pager-labo .list li:first-child,#core-liberation .col .block-pager-labo .list li.new-line{margin-left:0}
...
#core-liberation .block-benefits .block-content .text-benefits li h5,#core-liberation .block-benefits .block-content .text-benefits li h3,#core-liberation .block-benefits .block-content .text-benefits li p{margin-left:126px}
...
#core-liberation .col-contextual .block-promo .block-content ul li a,#core-liberation .col-contextual .block-promo .block-content a.arrow{background:url(http://s0.libe.com/libe/img/common/ico-lnk-arrow-red.gif?feba6ff926a7) no-repeat 0 4px;padding-left:15px}
...
#core-liberation .block-all-forums .block-top,#core-liberation .block-all-forums .block-content .forums-most{margin-bottom:28px}
...
#core-liberation .block-all-forums table th,#core-liberation .block-all-forums table td{padding:4px 0 6px}
...
#core-liberation .block-search-results .tpl-search-results .folder .object-content,#core-liberation .block-search-results .tpl-search-results .emission .object-content{min-height:53px}
...
#core-liberation .headrest h5,#core-liberation .headrest h4,#core-liberation .headrest h3{font-family:Verdana,sans-serif}
...
#core-liberation .cartridge .btn-comment,#core-liberation .cartridge .btn-back{text-align:center}
#core-liberation .cartridge .btn-comment span,#core-liberation .cartridge .btn-back span{display:block;padding:6px 7px 0;font-weight:700}
#core-liberation .cartridge a.btn-comment:hover,#core-liberation .cartridge a.btn-back:hover{text-decoration:none}
...
#core-liberation .cartridge-basic-bubble .segment,#core-liberation .cartridge-basic-bubble .plain{height:28px;border:1px solid;margin-right:20px}
...
#core-liberation .w23unit .cartridge-basic-bubble .text,#core-liberation .w17unit .cartridge-basic-bubble .text{margin-right:0}
...
.btn-basic span,.btn-basic a{display:block;padding:2px 1px 4px;text-decoration:none;text-align:center;font-size:11px;border:1px solid}
form .btn-basic input[type=button],form .btn-basic input[type=submit],form .btn-basic input[type=reset]{border:1px solid;padding:0 10px 4px;height:26px;cursor:pointer;cursor:hand;font-size:11px;font-family:Verdana,sans-serif}
.btn-laune span,.btn-laune a,.btn-monlibe span,.btn-monlibe a,.btn-zoneabo span,.btn-zoneabo a{display:block;padding:5px 5px 7px;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;text-decoration:none}
.btn-laune a:hover,.btn-monlibe a:hover,.btn-zoneabo a:hover{text-decoration:underline}
form .btn-laune input[type=button],form .btn-laune input[type=submit],form .btn-laune input[type=reset],form .btn-monlibe input[type=button],form .btn-monlibe input[type=submit],form .btn-monlibe input[type=reset],form .btn-zoneabo input[type=button],form .btn-zoneabo input[type=submit],form .btn-zoneabo input[type=reset]{border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;padding:0 10px 3px;height:25px;cursor:pointer;cursor:hand;font-size:12px;font-family:Verdana,sans-serif;border:0}
form .btn-monlibe input[type=reset]{opacity:.9}
.btn-rounded-degraded span,.btn-rounded-degraded a{display:block;border-radius:5px;-moz-border-radius:5px;-webkit-border-radius:5px;padding:7px 14px 11px;text-decoration:none;text-align:center;font-size:13px;font-weight:700}
.btn-rounded-degraded span:hover,.btn-rounded-degraded a:hover{text-decoration:none!important}
...
form .btn-rounded-degraded input[type=button]:hover,form .btn-rounded-degraded input[type=submit]:hover,form .btn-rounded-degraded input[type=button]:focus,form .btn-rounded-degraded input[type=submit]:focus{text-decoration:none}
...
.btn-read-digitalpaper span,.btn-read-digitalpaper a{display:block;min-height:32px;background:url(http://s0.libe.com/libe/img/common/reader_picto.png?8fdcc4850538) no-repeat right top;padding-right:50px;font-size:12px}
...
#core-liberation .bg-sprites-icons a.twitter,#core-liberation .bg-sprites-icons a.facebook,#core-liberation .bg-sprites-icons a.mail,#core-liberation .bg-sprites-icons a.star{display:block;background-image:url(http://s0.libe.com/libe/img/common/_sprites_icons/icons.png?9914d0d70a49);background-repeat:no-repeat}
...
.site-liberation .toolbox .txt-min:hover,.site-liberation .toolbox .txt-plus:hover,.site-liberation .toolbox .txt-reset:hover,.site-liberation .toolbox .comment:hover,.site-liberation .toolbox .facebook:hover,.site-liberation .toolbox .twitter{text-decoration:none}
...
#bar-liberation .content .close,#bar-liberation .content .open,#bar-liberation .content .login,#bar-liberation .content .personal-options,#bar-liberation .content .mail-box,#bar-liberation .content .activities-stream,#bar-liberation .content .other{display:none;border-left:1px solid;border-right:1px solid;border-bottom:1px solid;position:absolute;top:0;height:40px}
...
#core-liberation .block-activities .block-content ul li a,#bar-liberation .content ul.list li a,#core-liberation .block-activities .block-content ul li a:hover,#bar-liberation .content ul.list li a:hover{text-decoration:underline}
...
#bar-liberation #login-box-content form input[type=text],#bar-liberation #login-box-content form input[type=password]{display:block;clear:both;width:175px}
...
#page-paywall .content .form-login form p input[type=text],#page-paywall .content .form-login form p input[type=password]{border:1px solid;padding:0 10px 4px;width:160px;height:19px}
#page-paywall .content .form-login form p input[type=text]:focus,#page-paywall .content .form-login form p input[type=password]:focus{border:1px solid}
...
.site-liberation h5 a.theme:hover,.site-liberation a:hover h5 .theme{text-decoration:none}
...
.site-liberation .text-item p.titre,.site-liberation .text-item p.inter{margin-bottom:14px;font-family:Georgia,"Times New Roman",Times,serif;font-size:16px;font-weight:700}
...
.site-liberation .text-item h5,.site-liberation .text-item .question{font-family:Georgia,"Times New Roman",Times,serif;font-size:14px;font-weight:700;margin:21px 0 14px}
.site-liberation .text-item p span.nickname,.site-liberation .text-item h5 span.nickname{font-family:Georgia,"Times New Roman",Times,serif;font-size:14px;font-weight:700;color:#999}
...
.site-liberation a:hover,.site-liberation a:hover p,.site-liberation a:hover h6,.site-liberation a:hover h5,.site-liberation a:hover h4,.site-liberation a:hover h3,.site-liberation a:hover h2{text-decoration:underline}
...
.site-liberation .col-contextual .block-call-items .block-top h5{background:0;padding:0}
...
.site-liberation .block-call-items .mini-tpl .lnk-libeplus,.site-liberation .block-call-items .mini-tpl .lnk-libeplus-big{background:0;padding:0}
...
* html .site-liberation .block-call-items .mini-tpl h2.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus-big2.png?d4d49ea9ef21);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
* html .site-liberation .block-call-items .mini-tpl h3.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus-big2.png?d4d49ea9ef21);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
* html .site-liberation .block-call-items .mini-tpl .list-linked-items a.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus2.png?39fe048f4782);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
* html .site-liberation .block-call-items .mini-tpl h5.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus2.png?39fe048f4782);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
:first-child+html .site-liberation .block-call-items .mini-tpl h2.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus-big2.png?d4d49ea9ef21);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
:first-child+html .site-liberation .block-call-items .mini-tpl h3.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus-big2.png?d4d49ea9ef21);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
:first-child+html .site-liberation .block-call-items .mini-tpl .list-linked-items a.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus2.png?39fe048f4782);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
:first-child+html .site-liberation .block-call-items .mini-tpl h5.lnk-libeplus{background-image:url(http://s0.libe.com/libe/img/common/ico-lnk-libeplus2.png?39fe048f4782);background-repeat:no-repeat;background-position:right 4px;padding-right:60px}
...
.site-liberation .block-call-items .tpl-visual-square-left h5{font-family:Georgia,"Times New Roman",Times,serif;font-size:13px;font-weight:700}
.site-liberation .block-call-items .tpl-visual-square-left-arround h5{font-family:Georgia,"Times New Roman",Times,serif;font-size:13px;font-weight:700}
...
.site-liberation .block-call-items .tpl-search-results .object-picture .np .p1,.site-liberation .block-call-items .tpl-search-results .object-picture .np .p2{position:absolute;background-color:#fff;width:79px;height:102px;border:7px solid;border-left-width:4px;border-right-width:4px}
...
.site-liberation .block-call-items .tpl-visual-square-left h5,.site-liberation .block-call-items .tpl-visual-square-left h4,.site-liberation .block-call-items .tpl-visual-square-left h3,.site-liberation .block-call-items .tpl-visual-square-left .subtitle{margin-left:98px}
...
.site-liberation .block-call-items .tpl-visual-square-left .chat h5,.site-liberation .block-call-items .tpl-visual-square-left .chat .subtitle{font-family:Verdana,sans-serif;font-size:12px}
...
#header-liberation .header-base .nav .cat-labo .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-labo:hover .nav1 a,#header-liberation .header-base .nav .cat-labo .nav1 a:hover{background-color:#006a96}
#header-liberation .header-base .nav .cat-culture .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-culture:hover .nav1 a,#header-liberation .header-base .nav .cat-culture .nav1 a:hover{background-color:#e52d83}
#header-liberation .header-base .nav .cat-rebonds .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-rebonds:hover .nav1 a,#header-liberation .header-base .nav .cat-rebonds .nav1 a:hover{background-color:#00b3e2}
#header-liberation .header-base .nav .cat-ecrans .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-ecrans:hover .nav1 a,#header-liberation .header-base .nav .cat-ecrans .nav1 a:hover{background-color:#1d9b9a}
#header-liberation .header-base .nav .cat-mode .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-mode:hover .nav1 a,#header-liberation .header-base .nav .cat-mode .nav1 a:hover{background-color:#944d93}
#header-liberation .header-base .nav .cat-blogs .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-blogs:hover .nav1 a,#header-liberation .header-base .nav .cat-blogs .nav1 a:hover{background-color:#324c99}
#header-liberation .header-base .nav .cat-voyages .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-voyages:hover .nav1 a,#header-liberation .header-base .nav .cat-voyages .nav1 a:hover{background-color:#7baf1f}
#header-liberation .header-base .nav .cat-regions .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-regions:hover .nav1 a,#header-liberation .header-base .nav .cat-regions .nav1 a:hover{background-color:#f2a787}
#header-liberation .header-base .nav .cat-monlibe .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-monlibe:hover .nav1 a,#header-liberation .header-base .nav .cat-monlibe .nav1 a:hover{background-color:#fe9900}
#header-liberation .header-base .nav .cat-zoneabo .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-zoneabo:hover .nav1 a,#header-liberation .header-base .nav .cat-zoneabo .nav1 a:hover{background-color:#a00}
#header-liberation .header-base .nav .cat-food .nav1 .on a,#header-liberation .header-base .nav-no-js .cat-food:hover .nav1 a,#header-liberation .header-base .nav .cat-food .nav1 a:hover{background-color:#000}
...
#header-liberation .header-base .nav .cat-laune .nav2 a:hover,#header-liberation .header-base .nav .cat-laune .nav2 .on{color:#e20000}
#header-liberation .header-base .nav .cat-labo .nav2 a:hover,#header-liberation .header-base .nav .cat-labo .nav2 .on{color:#006a96}
#header-liberation .header-base .nav .cat-culture .nav2 a:hover,#header-liberation .header-base .nav .cat-culture .nav2 .on{color:#e52d83}
#header-liberation .header-base .nav .cat-rebonds .nav2 a:hover,#header-liberation .header-base .nav .cat-rebonds .nav2 .on{color:#00b3e2}
#header-liberation .header-base .nav .cat-ecrans .nav2 a:hover,#header-liberation .header-base .nav .cat-ecrans .nav2 .on{color:#1d9b9a}
#header-liberation .header-base .nav .cat-mode .nav2 a:hover,#header-liberation .header-base .nav .cat-mode .nav2 .on{color:#944d93}
#header-liberation .header-base .nav .cat-blogs .nav2 a:hover,#header-liberation .header-base .nav .cat-blogs .nav2 .on{color:#324c99}
#header-liberation .header-base .nav .cat-voyages .nav2 a:hover,#header-liberation .header-base .nav .cat-voyages .nav2 .on{color:#7baf1f}
#header-liberation .header-base .nav .cat-regions .nav2 a:hover,#header-liberation .header-base .nav .cat-regions .nav2 .on{color:#f2a787}
#header-liberation .header-base .nav .cat-monlibe .nav2 a:hover,#header-liberation .header-base .nav .cat-monlibe .nav2 .on{color:#fe9900}
#header-liberation .header-base .nav .cat-zoneabo .nav2 a:hover,#header-liberation .header-base .nav .cat-zoneabo .nav2 .on{color:#a00}
#header-liberation .header-base .nav .cat-food .nav2 a:hover,#header-liberation .header-base .nav .cat-food .nav2 .on{color:#000}
...
#core-liberation form input[type=text],#core-liberation form input[type=password]{border-color:#888}
#core-liberation form input[type=text]:focus,#core-liberation form input[type=password]:focus,#core-liberation form input[type=file]:focus,#core-liberation form textarea:focus,#core-liberation form select,#core-liberation form checkbox{outline-color:silver}
...
#core-liberation .form-monlibe input[type=text],#core-liberation .form-monlibe input[type=password],#core-liberation .form-monlibe textarea{border-color:#9d9d9d;background-color:#fff}
#core-liberation .form-monlibe-unlogged input[type=button]:hover,#core-liberation .form-monlibe-unlogged input[type=submit]:hover,#core-liberation .form-monlibe-unlogged input[type=reset]:hover{background:#878787}
...
.site-liberation .col-contextual .block-nobg{background:0}
...
.site-liberation .block-call-items .tpl-flash-news-29col,.site-liberation .block-call-items .tpl-flash-news-29col:last-of-type{border-bottom-color:#ddd}
.site-liberation .block-call-items .tpl-breaking-news,.site-liberation .block-call-items .tpl-breaking-news:last-of-type{border-bottom-color:#ddd}
...
#core-liberation .flat-comments .comment,#core-liberation .block-comments .comment_level_0{border-top-color:#878787}
...
#core-liberation .block-comments .block-content .comment_selected>.comment_outer .meta .note,#core-liberation .block-comments .block-content .comment_libe>.comment_outer .meta .note{color:#e20000}
...
#core-liberation .block-search-head .pagination,#core-liberation .block-search-results .pagination{background:0;border-color:#b7b7b7}
...
#core-liberation .block-search-head .pagination .disabled,#core-liberation .block-search-results .pagination .disabled,#core-liberation .block-search-head .pagination .current,#core-liberation .block-search-results .pagination .current{background-color:transparent}
...
#core-liberation .block-search-head .advanced .note .links,#core-liberation .block-search-head .advanced .note .links a{color:#87888a}
#core-liberation .block-search-head .advanced .searchform{background-color:#e5e5e5}
#core-liberation .block-search-head .advanced .searchform .period,#core-liberation .block-search-head .advanced .searchform .between,#core-liberation .block-search-head .advanced .searchform .source,#core-liberation .block-search-head .advanced .searchform .category{border-bottom-color:#fff}
#core-liberation .block-search-head .results{margin-bottom:15px}
...
#core-liberation .block-search-results .block-content .category,#core-liberation .block-search-results .block-content .folder,#core-liberation .block-search-results .block-content .emission{background-color:#f9f9f9}
...
#core-liberation .headrest-community h3,#core-liberation .headrest-community a.lnk-back,#core-liberation .headrest-community a.lnk-com{color:#555}
...
#core-liberation .cartridge a.btn-comment,#core-liberation .cartridge a.btn-back{color:#878787}
#core-liberation .cartridge a.btn-comment:hover,#core-liberation .cartridge a.btn-back:hover{color:#fa9900}
...
#core-liberation .cartridge-basic-bubble .segment,#core-liberation .cartridge-basic-bubble .plain{border-color:#ddd;background-color:#fdfdfd}
...
.site-liberation .btn-laune span,.site-liberation .btn-laune a,.site-liberation .btn-monlibe span,.site-liberation .btn-monlibe a,.site-liberation .btn-zoneabo span,.site-liberation .btn-zoneabo a{color:#fff}
.site-liberation .btn-laune a:hover,.site-liberation .btn-monlibe a:hover,.site-liberation .btn-zoneabo a:hover{color:#fff}
.site-liberation form .btn-laune input[type=button],.site-liberation form .btn-laune input[type=submit],.site-liberation form .btn-laune input[type=reset],.site-liberation form .btn-monlibe input[type=button],.site-liberation form .btn-monlibe input[type=submit],.site-liberation form .btn-monlibe input[type=reset],.site-liberation form .btn-zoneabo input[type=button],.site-liberation form .btn-zoneabo input[type=submit],.site-liberation form .btn-zoneabo input[type=reset]{color:#fff}
.site-liberation .btn-laune span,.site-liberation .btn-laune a{background:#e20000}
...
.site-liberation .btn-monlibe span,.site-liberation .btn-monlibe a{background:#878787}
.site-liberation form .btn-monlibe input[type=button],.site-liberation form .btn-monlibe input[type=submit],.site-liberation form .btn-monlibe input[type=reset]{background:#878787}
.site-liberation form .btn-monlibe input[type=button]:hover,.site-liberation form .btn-monlibe input[type=submit]:hover,.site-liberation form .btn-monlibe input[type=reset]:hover{background:#3c3c3c}
.site-liberation .btn-zoneabo span,.site-liberation .btn-zoneabo a{background:#a00}
.site-liberation #core-liberation form .btn-zoneabo input[type=button],.site-liberation #core-liberation form .btn-zoneabo input[type=submit]{background:#a00}
.site-liberation #core-liberation form .btn-zoneabo input[type=button]:hover,.site-liberation #core-liberation form .btn-zoneabo input[type=submit]:hover{background:#a00}
...
.site-liberation .btn-read-digitalpaper span,.site-liberation .btn-read-digitalpaper a{color:#2e2e2e}
...
.site-liberation .cat-monlibe .bg-sprites-icons .on .folder1,.site-liberation .cat-monlibe .bg-sprites-icons a:hover .folder1{background-position:-131px -84px}
...
.site-liberation .cat-monlibe .bg-sprites-icons .on .close1,.site-liberation .cat-monlibe .bg-sprites-icons a:hover .close1{background-position:-76px -99px}
...
.site-liberation .cat-monlibe .bg-sprites-icons .on .edit1,.site-liberation .cat-monlibe .bg-sprites-icons a:hover .edit1{background-position:-128px -101px}
.site-liberation .bg-sprites-icons .heart1,.site-liberation .bg-sprites-icons .heart1-laune,.site-liberation .bg-sprites-icons .heart1-black{width:12px;height:12px}
...
.site-liberation .toolbox .txt-min,.site-liberation .toolbox .txt-plus,.site-liberation .toolbox .txt-reset,.site-liberation .toolbox .comment,.site-liberation .toolbox .facebook,.site-liberation .toolbox .twitter{color:#818181}
.site-liberation .toolbox .txt-min:hover,.site-liberation .toolbox .txt-plus:hover,.site-liberation .toolbox .txt-reset:hover,.site-liberation .toolbox .comment:hover{color:#000}
...
#bar-liberation .content .close,#bar-liberation .content .open,#bar-liberation .content .login,#bar-liberation .content .personal-options,#bar-liberation .content .mail-box,#bar-liberation .content .activities-stream,#bar-liberation .content .other{background:#fff;border-left-color:#dadada;border-right-color:#dadada;border-bottom-color:#dadada}
#bar-liberation .content ul.list li{border-bottom-color:#dadada}
#core-liberation .block-activities .block-content ul li,#core-liberation .block-activities .block-content ul li a,#bar-liberation .content ul.list li,#bar-liberation .content ul.list li a{color:#222}
#core-liberation .block-activities .block-content ul li span,#bar-liberation .content ul.list li span{color:#878787}
...
#bar-liberation #personal-options-content ul.subscription strong,#bar-liberation #personal-options-content ul.subscription li.subscribe,#bar-liberation #personal-options-content ul.subscription li.subscribe a{color:#a40000}
...
#page-paywall .content .arguments .arg h4,#page-paywall .content .arguments .arg .price{color:#222}
...
#page-paywall .content .form-login form p input[type=text],#page-paywall .content .form-login form p input[type=password]{border-color:#888}
#page-paywall .content .form-login form p input[type=text]:focus,#page-paywall .content .form-login form p input[type=password]:focus{border-color:silver}
